 ...
 *  ** Teensy DO - Pin 11 to SD Card DI (MOSI) (Master Out, Slave In
 *  ** Teensy DI - Pin 12 to SD Card DO (MISO), Master In, Slave OUt
 *  ** Teensy SCK - Pin 13 to SD Card SCK/CLK, Clock
 *  ** Teensy CS - Pin 4 to SD Card CS/SS, Chip or Slave Select
 */
